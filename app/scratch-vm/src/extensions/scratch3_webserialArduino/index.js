...
class Scratch3ArduinoWebSerial {
        ...
        },
        {
          ...
          arguments: {
            VALUE: {
              type: ArgumentType.STRING,
              defaultValue:
                "0000000000011000000110000111111001111110000110000001100000000000",
            },
          },
        },
        "---",
  ...
  async tone_on(args, util) {
    ...
    const toneArray2 = [
      33, 35, 37, 39, 41, 44, 46, 49, 52, 55, 58, 62, 65, 69, 73, 78, 82, 87,
      93, 98, 104, 110, 117, 123, 131, 139, 147, 156, 165, 175, 185, 196, 208,
      220, 233, 247, 262, 277, 294, 311, 330, 349, 370, 392, 415, 440, 466, 493,
      523, 554, 587, 622, 659, 698, 740, 784, 831, 880, 932, 988, 1047, 1109,
